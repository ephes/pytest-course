"""
Django settings for locnus project.
...
SECRET_KEY = "django-insecure-i#14b5_psgj0!#(nlq@ed=zk-hn(u_az5dh@^9g33nm56#wtjh"
...
WSGI_APPLICATION = "locnus.wsgi.application"
